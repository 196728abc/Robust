...
data = pd.read_csv(
    r"E:\1_canopy_photosynthesis\photosynthesis_and_Global_Climate\SIF\data\meoto\TEST\Points\VPM_TROPOextend_1.csv",
    header=0, dtype=np.float64)
data1 = pd.read_csv(
    r"E:\1_canopy_photosynthesis\photosynthesis_and_Global_Climate\SIF\data\meoto\TEST\Points\VPM_TROPOextend_2.csv",
    header=0, dtype=np.float64)
...
book.save(
    r'E:\1_canopy_photosynthesis\photosynthesis_and_Global_Climate\SIF\data\meoto\TEST\KNN\total_train_test\VPM_TROPOextend.xlsx')
print()
